...
import { View, Text, Image, ScrollView, TouchableOpacity, SafeAreaView, StyleSheet, Modal } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.profileContainer}>
          <Image
            source={{ uri: 'https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png' }} // Substitua pela URL da imagem desejada
        ...
        <View style={styles.optionsContainer}>
          ...
          >
            ...
            <Icon name={showAccountInfo ? "chevron-up" : "chevron-down"} size={20} color="#000" />
          </TouchableOpacity>
          
          {showAccountInfo && (
            <View style={styles.accountInfoContainer}>
              <Text style={styles.accountInfoText}>Nome: {user?.displayName || 'Não disponível'}</Text>
              <Text style={styles.accountInfoText}>Email: {user?.email || 'Não disponível'}</Text>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>
              Estamos aqui para ajudar! Se você tiver qualquer dúvida, precisar de suporte ou desejar fornecer feedback, entre em contato pelo email:
            </Text>
            ...
            <Text style={styles.modalText}>
              ...
              {'\n\n'}
              Sua satisfação é a nossa prioridade, e estamos prontos para ajudar no que for necessário!
            </Text>
            <TouchableOpacity
