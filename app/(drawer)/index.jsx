...
const Home = () => {
  ...
  const curiosidades = [
    { id: '1', texto: 'O Brasil é um dos maiores produtores de café, com uma produção de 60 milhões de sacas.', fonte: 'Fonte: CNN Brasil' },
    { id: '2', texto: 'O agronegócio brasileiro responde por aproximadamente 23% do PIB nacional.', fonte: 'Fonte: Notícias Agrícolas' },
    { id: '3', texto: 'Brasil importa fertilizantes para impulsionar a descarbonização do agronegócio.', fonte: 'Fonte: CNN Brasil' },
    { id: '4', texto: 'Plantio de soja chega a 68,36% da área no Brasil, com bons avanços na safra 2023/24.', fonte: 'Fonte: Notícias Agrícolas' },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity style={styles.button} accessible={true} accessibilityLabel="Mais sobre plantas">
          <Icon name="leaf" size={24} color="#FFC107" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} accessible={true} accessibilityLabel="Mais sobre maçãs">
          <Icon name="apple" size={24} color="#FFC107" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} accessible={true} accessibilityLabel="Mais sobre árvores">
      ...
      <View style={styles.tabsContainer}>
        ...
        <TouchableOpacity style={styles.tab} onPress={() => setActiveTab('book')}>
